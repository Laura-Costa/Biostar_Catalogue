      ...
      PI=4.D0*ATAN(1.D0)
*     PRINT *, 'PI =', PI
*     REAL(KIND=16) :: PI = 3.1415926535897932d0
      PRINT *, 'PI =', PI

C     ar da HD 146233 no Hipparcos (em graus decimais) = 243.90472242	
C     dr da HD 146233 no Hipparcos (em graus decimais) = -8.36823651
   
      ar = 243.90472242d0 * PI / 180d0
      PRINT *, 'ra em radianos (Hipparcos):', ar
      dr = -8.36823651d0 * PI / 180.d0
      PRINT *, 'dc em radianos (Hipparcos):', dr

C     ar da HD 146233 no Gaia (em graus decimais) = 243.90633606005997
C     dr da HD 146233 no Gaia (em graus decimais) = -8.371641161548801

C     ar da HD 146233 no Gaia (em radianos) = 4.25696863072382
C     dr da HD 146233 no Gaia (em radianos) = -0.1461127020645091
...
*     ep1=2000.d0
      ...
      pmDE = -495.84d0
      PRINT *, 'pmDE em milisegundos de arco por ano:', pmDE
      pmRA = 232.16d0
      PRINT *, 'pmRA em milisegundos de arco por ano:', pmRA
      pmDE_radians = ((pmDE/1000.d0) / 3600.d0) * PI / 180.d0
      PRINT *, 'pmDE em radianos:', pmDE_radians
      pmRA_radians = ((pmRA/1000.d0) / 3600.d0) * PI / 180.d0
      PRINT *, 'pmRA em radianos:', pmRA_radians


      ep0 = 2000.0d0
      PRINT *, 'época inicial:', ep0
      ep1 = 2016.0d0
      PRINT *, 'época final:', ep1


*     aqui, corrige movimentos proprios em ar e dr
*     antes de submeter

      ar = ar + pmRA_radians * (ep1 - ep0)
      PRINT *, 'ar em radianos com movimento próprio corrigido:', ar
      dr = dr + pmDE_radians * (ep1 - ep0)
      PRINT *, 'dc em radianos com movimento próprio corrigido:', dr		
