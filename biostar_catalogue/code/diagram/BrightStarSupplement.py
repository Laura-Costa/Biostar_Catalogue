...
# Criar o diagrama BrightStarSupplement_MV_versus_B_minus_V.pdf

cursor.execute("select TRIM(BrightStarSupplement.simbad_parallax) + 0, "
...
fig.suptitle("Bright Star Supplement Catalogue: ${}$ estrelas em um raio de ${:.4f}$pc $(π ≥ {:.7f}'')$".format(len(value), 1.0 / (min_simbad_parallax / 1000.0), min_simbad_parallax / 1000.0), fontsize=8)
...
ax.xaxis.set_minor_locator(MultipleLocator(0.20/9))
...
# salvar diagrama
plt.savefig('/home/lh/Desktop/Catalogo_GAIA/biostar_catalogue/files/BrightStarSupplement/diagram/BrightStarSupplement_MV_versus_B_minus_V.pdf')
