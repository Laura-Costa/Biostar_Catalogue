...
#import sys
#sys.path.insert(0,'/home/lh/Documents/biostar_catalogue/code/')
import database 
...
with open("/home/lh/Documents/biostar_catalogue/code/database/input/hipparcos.csv", "r") as csv_file:
    ...
    for line in csv_file:
        ...
        # load hip
        database.insert_key(cursor, table_name, column_key_name, line, 0)
        ...
        for(column_name, index) in columns_names_and_indexes:
            database.update_table(cursor, table_name, column_name, line, index, column_key_name, lastrowid)
