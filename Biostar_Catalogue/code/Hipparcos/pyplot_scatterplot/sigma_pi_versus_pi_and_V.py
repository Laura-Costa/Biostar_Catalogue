...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'hipparcos/pyplot_scatterplot/#/sigma_pi_versus_pi.#',
          100.0, 10.0,
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'hipparcos/pyplot_scatterplot/#/sigma_pi_versus_V.#',
          1.0, 10.0,
