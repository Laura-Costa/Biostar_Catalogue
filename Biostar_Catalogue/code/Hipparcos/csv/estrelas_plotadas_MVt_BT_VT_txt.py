...
for i in range(len(e_Plx_list)):
    if e_Plx_list[i] is not None:
        ...
        e_Plx_list[i] = f"{e_Plx_list[i]:05.2f}"
...
cont = 0
with open("/home/lh/Desktop/Biostar_Catalogue/Biostar_Catalogue/output_files/Hipparcos/csv/estrelas_plotadas_MVt_Bt_Vt.txt", "w") as text_file:
