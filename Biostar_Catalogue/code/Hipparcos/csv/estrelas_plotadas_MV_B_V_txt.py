...
cursor.execute("select {father_table}.HIP as HIP_order, "
         ...
         "{father_table}.B_V is not null and "
         "{father_table}.Vmag is not null "
...
cont = 0
with open("/home/lh/Desktop/Biostar_Catalogue/Biostar_Catalogue/output_files/Hipparcos/csv/estrelas_plotadas_MV_B_V.txt", "w") as text_file:
