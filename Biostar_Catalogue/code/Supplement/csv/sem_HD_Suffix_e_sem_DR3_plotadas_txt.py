...
cursor.execute("""select {father_table}.HD as HD, """
               ...
               """order by cast(substring(HD,3) as unsigned) asc""".format(x_axis=x_axis,
                                                                           y_axis=y_axis,
...
cont = 0
with open("/home/lh/Desktop/Biostar_Catalogue/Biostar_Catalogue/output_files/Supplement/csv/estrelas_plotadas_MV_B_V.txt", "w") as text_file:
