...
query = ("SELECT "
        ...
        "WHERE "
        "( "
        "parallax >= 50.0000 or (parallax < 50.0000 and parallax + 3 * parallax_error >= 50.0000) "
        ") "
        "or "
        "( "
...
#print(type(data))
#print(data)
outputFileName = "/home/lh/Desktop/Biostar_Catalogue/Biostar_Catalogue/code/database/input_files/Gaia.csv"
