...
son_table = "BrightStarSupplementMultiple"
...
father_table_BrightStarSupplement = 'BrightStarSupplement'
father_table_BrightStarSupplement_column_key = 'ordinal_number'
...
cursor.execute("create table {son_table}( "
               ...
               "ordinal_number_BrightStarSupplement int null, "
               "HIP char(100) null, "
               ...
               "foreign key(ordinal_number_BrightStarSupplement) references {father_table_BrightStarSupplement}({father_table_BrightStarSupplement_column_key}) on delete restrict"
               ")".format(son_table=son_table,
                          ...
                          father_table_BrightStarSupplement=father_table_BrightStarSupplement,
                          father_table_BrightStarSupplement_column_key=father_table_BrightStarSupplement_column_key))
