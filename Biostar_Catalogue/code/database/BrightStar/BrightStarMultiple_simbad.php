<?php
    ...
    while($row = mysqli_fetch_array($query)) {
        ...
        if(!is_null($simbad_parallax_source) && !str_contains($simbad_parallax_source, "~")){
            $simbad_parallax_source_query = ("update BrightStarMultiple set simbad_parallax_source = '" . $simbad_parallax_source . "' where ordinal_number = " . $last_ordinal_number);
        ...
        if(!is_null($simbad_SpType) && !str_contains($simbad_SpType, "~")){
            $simbad_SpType_query = ("update BrightStarMultiple set simbad_SpType = '" . $simbad_SpType . "' where ordinal_number = " . $last_ordinal_number);
        ...
        mysqli_query($conn, "update BrightStarMultiple set BrightStarMultiple.designation = BrightStarMultiple.simbad_DR3 where BrightStarMultiple.simbad_DR3 in (select CAT1.designation from CAT1)");
    }
