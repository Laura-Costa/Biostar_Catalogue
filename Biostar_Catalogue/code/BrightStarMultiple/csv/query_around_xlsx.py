...
for (simbad_name_value, simbad_parallax_value, simbad_parallax_source_value, simbad_V_value,
...
workbook = xlsxwriter.Workbook('/home/lh/Desktop/Biostar_Catalogue/Biostar_Catalogue/output_files/BrightStarMultiple/csv/query_around_estrelas_sem_DR3.xlsx')
sheet_plotadas = workbook.add_worksheet("plotadas")

sheet_plotadas.write_column(0, 0, simbad_name)
