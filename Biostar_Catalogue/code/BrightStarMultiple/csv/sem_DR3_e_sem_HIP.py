...
cursor.execute("""select distinct BrightStarMultiple.simbad_name, """
               ...
               """BrightStarMultiple.simbad_HIP is null """
               """into outfile '/var/lib/mysql-files/sem_DR3_e_sem_HIP.csv' """ 
               """fields optionally enclosed by '"' """
               """terminated by ',' """
               """lines terminated by '\n' """)

file = pd.read_csv('/var/lib/mysql-files/sem_DR3_e_sem_HIP.csv', header=None)
file.to_csv("/home/lh/Desktop/Biostar_Catalogue/Biostar_Catalogue/output_files/BrightStarMultiple/csv/sem_DR3_e_sem_HIP.csv", header=header, index=None)
os.remove("/var/lib/mysql-files/sem_DR3_e_sem_HIP.csv")
