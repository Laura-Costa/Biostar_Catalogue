...
for ext in ['jpg']:
    f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/' + ext + '/LNA2_MG_Bp_Rp.' + ext, 0.25, 1.0, r'$B_p-R_p$', r'$M(G)$', 8, 0.03, 0.01, 0.20, 0.87, 'CAT1', xrot=0, redx=6, redy=8)
