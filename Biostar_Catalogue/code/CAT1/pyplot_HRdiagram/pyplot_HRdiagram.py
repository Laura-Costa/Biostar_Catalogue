...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/MRp_Bp_Rp.#',
          1.0, 3.0,
          r'$B_p-R_p$', r'$M(R_p)$', 8.0,
          0.20, 0.20, 0.20, 0.20,
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/MRp_Bp_Rp_ampliado.#',
          0.50, 1.0,
          r'$B_p-R_p$', r'$M(Rp)$', 8.0,
          0.20, 0.20, 0.20, 0.0,
          'CAT1', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
          axeslabelsize=10,
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/MRp_G_Rp.#',
          1.0, 3.0,
          r'$G-R_p$', r'$M(R_p)$', 8.0,
          0.20, 0.20, 0.20, 0.20,
          'CAT1', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/MRp_G_Rp_ampliado.#',
          0.50, 1.0,
          r'$G-R_p$', r'$M(R_p)$', 8.0,
          0.20, 0.20, 0.20, 0.0,
          'CAT1', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/MRp_Bp_G.#',
          1.0, 3.0,
          r'$B_p-G$', r'$M(R_p)$', 8.0,
          0.20, 0.20, 0.20, 0.20,
          'CAT1', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/MRp_Bp_G_ampliado.#',
          0.50, 1.0,
          r'$B_p-G$', r'$M(R_p)$', 8.0,
          0.20, 0.20, 0.20, 0.0,
          'CAT1', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/MBp_Bp_Rp.#',
          1.0, 3.0,
          r'$B_p-R_p$', r'$M(B_p)$', 8.0,
          0.20, 0.20, 0.20, 0.20,
          'CAT1', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
          axeslabelsize=10,
          x_minor_gap=10, y_minor_gap=10)
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/MBp_Bp_Rp_ampliado.#',
          0.50, 1.0,
          r'$B_p-R_p$', r'$M(B_p)$', 8.0,
          0.20, 0.20, 0.20, 0.0,
          'CAT1', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/MBp_G_Rp.#',
          1.0, 3.0,
          r'$G-R_p$', r'$M(B_p)$', 8.0,
          0.20, 0.20, 0.20, 0.20,
          'CAT1', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/MBp_G_Rp_ampliado.#',
          0.50, 1.0,
          r'$G-R_p$', r'$M(B_p)$', 8.0,
          0.20, 0.20, 0.20, 0.0,
          'CAT1', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/MBp_Bp_G.#',
          1.0, 3.0,
          r'$B_p-G$', r'$M(B_p)$', 8.0,
          0.20, 0.20, 0.20, 0.20,
          'CAT1', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/MBp_Bp_G_ampliado.#',
          0.50, 1.0,
          r'$B_p-G$', r'$M(B_p)$', 8.0,
          0.20, 0.20, 0.20, 0.0,
          'CAT1', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/MG_Bp_Rp.#',
          1.0, 3.0,
          r'$B_p-R_p$', r'$M(G)$', 8.0,
          0.20, 0.20, 0.20, 0.20,
          'CAT1', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/LNA_MG_Bp_Rp.#',
          1.0, 3.0,
          r'$B_p-R_p$', r'$M(G)$', 8.0,
          0.20, 0.20, 0.20, 0.20,
          'CAT1', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/MG_Bp_Rp_ampliado.#',
          0.50, 1.0,
          r'$B_p-R_p$', r'$M(G)$', 8.0,
          0.20, 0.20, 0.20, 0.0,
          'CAT1', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/MG_G_Rp.#',
          1.0, 3.0,
          r'$G-R_p$', r'$M(G)$', 8.0,
          0.20, 0.20, 0.20, 0.20,
          'CAT1', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/MG_G_Rp_ampliado.#',
          0.50, 1.0,
          r'$G-R_p$', r'$M(G)$', 8.0,
          0.20, 0.20, 0.20, 0.0,
          'CAT1', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/MG_Bp_G.#',
          1.0, 3.0,
          r'$B_p-G$', r'$M(G)$', 8.0,
          0.20, 0.20, 0.20, 0.20,
          'CAT1', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
...
f.diagram(cursor, query, query_emphasis, colors, HDs, 'CAT1/pyplot_HRdiagram/#/MG_Bp_G_ampliado.#',
          0.50, 1.0,
          r'$B_p-G$', r'$M(G)$', 8.0,
          0.20, 0.20, 0.20, 0.0,
          'CAT1', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
