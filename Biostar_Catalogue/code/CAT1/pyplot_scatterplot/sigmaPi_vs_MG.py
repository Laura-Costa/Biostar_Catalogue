...
f.diagram(cursor, query, query_emphasis, colors, HDs,'CAT1/pyplot_scatterplot/jpg/parallax_error_MG.jpg', 1.25, 0.5, r'$M(G)$', r'$σ(π)$', 2.0, 0.20, 0.20, 0.20, 0.20, 'CAT1')
(query, query_emphasis) = sql_query_zoom('parallax_error', 'MG')
diagram(cursor, query, query_emphasis, colors, [],'CAT1/pyplot_scatterplot/jpg/parallax_error_MG_ampliado.jpg', 1.25, 0.5, r'$M(G)$', 'σ(π)', 6.0, 0.20, 0.20, 0.20, 0.20, 'CAT1: estrelas com σ(π) > 1.0 (mas)')
