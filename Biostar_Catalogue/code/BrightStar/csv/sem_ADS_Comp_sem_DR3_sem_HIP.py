...
cursor.execute("""select {father_table}.HR, """
               ...
               """{father_table}.simbad_HIP is null """
               """into outfile '/var/lib/mysql-files/estrelas_sem_ADS_Comp_e_sem_DR3_e_sem_HIP.csv' """ 
               """fields optionally enclosed by '"' """
               """terminated by ',' """
               """lines terminated by '\n' """.format(father_table=father_table,
                                               son_table=son_table))

file = pd.read_csv('/var/lib/mysql-files/estrelas_sem_ADS_Comp_e_sem_DR3_e_sem_HIP.csv', header=None)
file.to_csv("/home/lh/Desktop/Biostar_Catalogue/Biostar_Catalogue/output_files/BrightStar/csv/estrelas_sem_ADS_Comp_e_sem_DR3_e_sem_HIP.csv", header=header, index=None)
os.remove("/var/lib/mysql-files/estrelas_sem_ADS_Comp_e_sem_DR3_e_sem_HIP.csv")