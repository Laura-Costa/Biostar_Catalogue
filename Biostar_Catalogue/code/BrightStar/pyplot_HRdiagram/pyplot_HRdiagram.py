...
def emphasis_diagram(ax, cursor, query_emphasis, path, colors, hds, size):
    ...
    for (HD_value, color) in zip(hds, colors):
        ...
        ax.scatter(value_emphasis[0][1], value_emphasis[0][2], s=14, color=color, edgecolor='none', marker='o', zorder=3, label=value_emphasis[0][0])
...
diagram(cursor, Multiple, emphasis, colors, hds, 'BrightStarMultiple/pyplot_HRdiagram/#/query_around_MV_B_V.#',
          0.5, 3.0,
          r'$B-V \; (simbad)$', r'$M(V) \; (simbad)$', 13.0,
          0.20, 0.20, 0.50, 0.50,
          'Query Around (Bright Star)', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
          xy_labels_fontsize=10,
          x_minor_gap=5, y_minor_gap=10)

diagram(cursor, BrightStar, emphasis, colors, hds, 'BrightStar/pyplot_HRdiagram/#/MV_B_V.#',
          0.50, 3.0,
          r'$B-V$', r'$M(V)$', 13.0,
          0.20, 0.20, 0.50, 2.0,
          'Bright Star', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
          xy_labels_fontsize=10,
          x_minor_gap=5, y_minor_gap=10)

diagram(cursor, BrightStar_plus_Multiple, emphasis, colors, hds, 'BrightStar+BrightStarMultiple/pyplot_HRdiagram/#/MV_B_V.#',
          0.50, 3.0,
          r'$B-V$', r'$M(V)$', 13.0,
          0.20, 0.20, 0.50, 0.50,
          'Bright Star + Query Around', xrot=0, minortickwidth=1.0, majortickwidth=1.3, dp=1,
          xy_labels_fontsize=10,
          x_minor_gap=5, y_minor_gap=10)
