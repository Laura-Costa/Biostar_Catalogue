...
C     converter ar do Hipparcos de graus decimais para radianos 
      ar = 243.90472242d0 * PI / 180d0
      PRINT *, 'ar em radianos (Hipparcos):', ar
      
C     converter dr do Hipparcos de graus decimais para radianos
      dr = -8.36823651d0 * PI / 180.d0
      PRINT *, 'dr em radianos (Hipparcos):', dr
          
C     converter pmDE do Hipparcos de milisegundos de arco por ano para radianos por ano
      pmDE = -495.84d0
      pmDE = ((pmDE/1000.d0) / 3600.d0) * PI / 180.d0
          
C     converter pmRA do Hipparcos de milisegundos de arco por ano para radianos por ano      
      pmRA = 232.16d0
      pmRA = ((pmRA/1000.d0) / 3600.d0) * PI / 180.d0

C     definir ep0 como a época do Hipparcos
      ep0 = 2000.0d0
      
C     definir ep1 como a época do Gaia
      ep1 = 2016.0d0
...
*     antes de submeter
      ...
      ar = ar + pmRA * (24.75)
      dr = dr + pmDE * (24.75)
      PRINT *, 'ar e dr após correções:'
      PRINT *, 'ar(radianos) =', ar, 'dr(radianos) =', dr
      
C     call prece(ep0,ep1,ar,dr)
C     PRINT *, ' '
C     PRINT *, 'ar e dr após correções:'
C     PRINT *, 'ar(radianos) =', ar, 'dr(radianos) =', dr
           
C     converter ar do Gaia de graus decimais para radianos
C     PRINT *, 'ar em radianos (Gaia):', 243.90633606005997 * PI / 180d0
      
C     converter dr do Gaia de graus decimais para radianos
C     PRINT *, 'dr em radianos (Gaia):', -8.371641161548801 * PI / 180d0
