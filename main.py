...
def diagramas_gaia():
    ...
    cursor.execute("select * from Produto_Gaia order by numero_ordinal_do_registro")
    value = cursor.fetchall()
...
def diagramas_hipparcos():
    ...
    cursor.execute("select * from Produto_Hipparcos order by numero_ordinal_do_registro limit 1774")
    value = cursor.fetchall()
